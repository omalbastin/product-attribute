...
class ProductProduct(models.Model):
    ...
    image_1920 = fields.Image(compute="_compute_image_ids",)
    #
    # def _set_image_1920(self):
    #     for product in self:
    #         if len(product.image_ids) < 1:
    #             super(ProductProduct, product)._set_image_1920()
    #         else:
    #             product.image_variant_1920 = product.image_ids[0].image_1920
